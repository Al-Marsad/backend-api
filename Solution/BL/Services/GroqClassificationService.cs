...
namespace BL.Services
{
    public class GroqClassificationService : IClassificationService<IncidentClassificationInput, MatchedArticle, ClassificationResult>
    {
            ...
            List<MatchedArticle> matchedArticles)
        {
            ...
            var systemPrompt = """
                أنت محلل قانوني متخصص في القانون الجنائي الدولي ونظام روما الأساسي واتفاقيات جنيف الاربعة.
                ...
                - قائمة مواد مقترحة من نظام روما الأساسي والقانون الدولي واتفاقيات جنيف الاربعة كمرجع فقط.
...

                {
                    RulesViolated: "
                        ...
                        مع ذكر رقم المادة ومصدرها واسم الجريمة، إن لم تتوفر أي انتهاكات قابلة للإثبات، صرّح بذلك"
                    , 
                    LegalReasoning: "
            ...
            var userPrompt = $"""
                ## المواد القانونية المرجعية من نظام روما الأساسي والقانون الدولي واتفاقيات جنيف الاربعة:
                {context}
